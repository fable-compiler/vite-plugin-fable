...
- Updated Fable.Compiler to 5.16.2 and `@fable-org/fable-library-js` to 2.7.1. Decimals below 0.1 now keep their sign and respect the requested precision when formatted, and a value that rounds to zero no longer prints a minus sign.
